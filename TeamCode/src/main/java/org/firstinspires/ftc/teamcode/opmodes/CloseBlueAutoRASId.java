...
@Autonomous(name = "RASI'd close blue auto")
public class CloseBlueAutoRASId extends LinearOpModeCamera {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        rasiActions = new RasiActions("AutoBlue", rasiTag, this, gamepad1, gamepad2, telemetry, hardwareMap);
