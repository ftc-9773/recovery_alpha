...
@Autonomous(name = "Peekskill Close Red Auto")
public class NewCloseRedAuto extends LinearOpModeCamera{
    ...
    CubeTray myCubeTray;
    Gyro myGyro;
    SafeJsonReader mySafeJsonReader = new SafeJsonReader("NewCloseRedAutoParameters");
...
//        autonomouspath = chooseAutonomousPath(true, (char)1);
        ...
        // Lower intake
        myRelicSystem.runSequence(.75, true, true);
