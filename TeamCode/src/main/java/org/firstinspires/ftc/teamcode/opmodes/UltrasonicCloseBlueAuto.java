...
@Autonomous(name = "Close Blue Ultrasonic", group = "Auto Paths")
public class UltrasonicCloseBlueAuto extends LinearOpModeCamera {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        rasiActions = new RasiActions("5GlyphBlueUltra", null, this, gamepad1, gamepad2, telemetry, hardwareMap);
